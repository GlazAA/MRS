...
INSERT OR IGNORE INTO facility_systems (id, facility_id, name, description, is_active) VALUES
    (1, 1, 'Гипаксическая система предотвращения пожара', 'Демо', 1),
    (2, 2, 'Гипаксическая система предотвращения пожара', 'Демо', 1),
    (3, 3, 'Гипаксическая система предотвращения пожара', 'Демо', 1);
